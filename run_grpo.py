...
def grpo_function(
    ...
    trainer = GRPOTrainer(
      ...
      reward_funcs=[format_reward_func,equation_reward_func], # both reward 
      args=training_args,
...
# nohup python run_grpo.py --config grpo.yaml > grpotest.txt &

# nohup accelerate launch --num_processes 0 --config_file deepspeed_zero3.yaml run_grpo.py --config grpo.yaml > grpo_dis_text.txt &